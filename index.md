...
This document provides instructors with an historical overview about the history of depictions of California as an island on maps and is intended to establish an intellectual context for the maps in the accompanying primary source material set. 

The narrative is divided into sections, presented chronologically. Within each there are high-level talking points providing an umbrella context for the objects in that section. Each object is represented with a thumbnail image, a bibliographic citation, and notes about that object, including things students can observe. 
...
> * *[Measuring the California Coast](https://davidrumseymapcenter.github.io/measuring-california-coast/)* Featuring maps from 1800-1900
